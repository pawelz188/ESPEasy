...
bool ESPEasy_Scheduler::setRulesTimer(unsigned long msecFromNow, unsigned int timerIndex, int recurringCount, bool startImmedately) {
  ...
  setNewTimerAt(timerID, millis() + startImmedately ? 10 : msecFromNow);
  return true;
}
